...
class CouriersLoader:
    ...
    WF_KEY = "example_api_couriers_origin_to_stg_workflow"
    ...
    def run_copy(self) -> int:
        ...
        with self.pg_dest.connection() as conn:
            ...
            load_queue = self.collection_loader.get_couriers(last_loaded_ts, self._SESSION_LIMIT)
            ...
            wf_setting.workflow_settings[self.LAST_LOADED_TS_KEY] = current_timestamp.isoformat()
