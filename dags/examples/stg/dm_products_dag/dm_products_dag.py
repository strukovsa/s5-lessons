...
def sprint5_example_dds_products_dag():
    ...
    users_dict >> restaurants_dict >> timestamps_dict >> products_dict  # type: ignore


stg_dds_products_dag = sprint5_example_dds_products_dag()
